...
export const Video = () => {
  ...
  useEffect(()=>{
    ...
    const fetchData=async()=>{
      try {
        dispatch(fetchStart());
        const fetchVideo = await axios.get(`/api/video/getVideo/${videoPath}`);
        dispatch(fetchSuccess(fetchVideo.data));
        const fetchChannel = await axios.get(`/api/user/find/${fetchVideo.data.userId}`);
